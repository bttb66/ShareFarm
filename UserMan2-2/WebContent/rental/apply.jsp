...
%>   
   <script type="text/javascript" language="javascript">
      // 이메일
   function applyMachine() {  //applydao에 있는 이름이 applyfarm임
   ...
   <div id="container">
      <div id="sub_con">
         ...
         <div class="contents_con">
            ...
            <form id="form" name="form" method="POST" action="/UserMan2/machine/apply?machineId=<%=String.valueOf(machine.getMachineId()) %>&machineName=<%=machine.getMachineName() %>">
                  ...
                  <div class="write_con">
                     ...
                     <div class="list_div">
                        ...
                        <div class="input_con">
                           ...
                           <%--    <input type="hidden" id="machineId" value="${machine.machineId}">
                              <input type="hidden" id="machineName" value="${machine.machineName}"> --%>
                           </table>
                        </div>
                     </div>
                  </div>
                   ...
                   <div class="btn_con">
                     ...
                     <input id="applyBtn" type="image" src="UserMan2/images/rental/rental_sub01_write_btn02.png" alt="등록하기"  onClick="applyMachine()">
                  </div>
               </div>
            </form>
            <!-- <div class="btn_con">
