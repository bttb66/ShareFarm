...
%> 
<a href="/UserMan2/machine/detail?machineId=<%=apply.getMachineId() %>">
<tr>
   <td><%=apply.getName() %></td>
   <td><%=apply.getStartDate() %></td>
   <td><%=apply.getEndDate() %></td>
   <td><a href="/UserMan2/apply/machineOk?applyId=<%=apply.getApplyId()%>"><button id="ok">승인</button></a></td>
   <td><a href="/UserMan2/apply/machineCancel?applyId=<%=apply.getApplyId()%>"><button id="cancel">거절</button></a></td>
