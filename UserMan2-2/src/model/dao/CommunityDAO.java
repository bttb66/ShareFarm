...
public class CommunityDAO {
	...
	public int create(Community community) throws SQLException {
		String sql = "INSERT INTO COMMUNITY (postId, title, content, userId) VALUES (?, ?, ?, ?)";		
		Object[] param = new Object[] {"post_seq", community.getTitle(), community.getContent(), community.getUserId()};				
	...
	public int createComment(Comment comment)throws SQLException{
		String sql = "INSERT INTO COMMENTINFO (commentId, content, userId, postId)VALUES(?, ?, ?, ?)";
		Object[] parameters = new Object[] {"comment_seq", comment.getContent(), comment.getUserId(), comment.getPostId()};
