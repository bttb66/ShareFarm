...
<% 
   ...
   String isComplete = String.valueOf(request.getAttribute("isComplete"));
   ...
   <script type="text/javascript" language="javascript">
      ...
      jQuery(document).ready(function($){
         ...
         if('<%=msg %>' == 'success'){
				...
				alert("자신의 항목에 신청할 수 없습니다.");
			}
         if('<%=isComplete %>' == '1'){
         	$('#applyBtn').attr('onclick', '').click(function(){
         		alert('이미 거래가 완료된 항목입니다.');
         		return false;
         	});
         }
      });
         ...
         <div class="contents_con">
            ...
            <div class="rental_sub01_view_con">
                     ...
                     <div class="slide_wrap" id="slide_num1">
                        <div>
                           ...
                           <span class="slide_btn">
                              <img class="prev" rel="-1" onclick="slide_btn($(this))" src="/UserMan2/images/rental/rental_sub01_view_slide_prev_btn.png" alt="이전보기">
                              <img class="next" rel="+1" onclick="slide_btn($(this))" src="/UserMan2/images/rental/rental_sub01_view_slide_next_btn.png" alt="다음보기">
                           </span>
                        </div>
               ...
               <div class="right_con">
                  ...
                  <div class="btn_con">
                     ...
                     <a href="<c:url value='/farm/apply'>
                        <c:param name='farmId' value='<%=String.valueOf(farm.getFarmId())%>'/>
                        <c:param name='host' value='${host.userId }'/>
                       </c:url>" id="applyBtn">
                        ...
                        <tbody>
                           <tr>
                              <td colspan="2" align="center" class="img_td">
                                 <img src="/UserMan2/images/rental/rental_sub01_view_person_img.png" alt="등록자 이미지" width="272" height="160" />
                                 <c:if test="${isComplete eq '1'}">	
                                 	<img src="/UserMan2/images/rental/rental_sub01_view_img_end.png" alt="거래완료" width="272" height="160" class="end_img" />
                              	</c:if>
                              </td>
                           </tr>
                           <tr>
            ...
            <div id="alert_con">
               ...
               <div class="contents_con">
                  <div class="intro_con">
                     <div class="img_con">
                        <img src="/UserMan2/images/rental/rental_sub01_view_alert_img.png" alt="얼럿창 이미지" />
                     </div>
