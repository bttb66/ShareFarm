...
<%@page import="model.*" %>
      ...
      <div id="sub_con">
         ...
         <div id="nav">
            <div class="nav">
               <ul>
                  <li>
                     <a href="<c:url value='/farm/list'/>" class="">
                        일일농장
                     </a>
                  </li>
                  <li>
                  	  <a href="<c:url value='/farm/register'/>" class="on">
                        등록하기
                     </a>
                  </li>
               </ul>
         ...
         <div class="contents_con">
            ...
            <form id="form" name="form" method="POST" action="<c:url value='/farm/register' />">
               ...
               <!--    <div class="si_con">
                     <div class="sort_con">
                        <table cellpadding="0" cellspacing="0">
                           <tbody>
                              <tr>
                                 <td align="left" class="title_td" width="47">
                                    <span>
                                       구분
                                    </span>
                                 </td>
 ...
 -->
                     ...
                     <table cellpadding="0" cellspacing="0">
                        <tbody>
                           ...
                           <tr>
                              <td align="left" class="title_td">
                                 <span>
                                    <font class="dot">•</font> 면적
                                 </span>
                              </td>
                              <td colspan="3" align="left" class="info_td">
                                 <input type="text" id="area" name="area" class="input" style="width:268px; margin-right:10px;" />
                                 <span>
                                    (단위: 평방미터)
                                 </span>
                              </td>
                  ...
                  <div class="btn_con">
                        ...
                        onclick="farmRegist()"> -->
                     <input type="button" value="제출하기" onClick="farmCreate()" class="input_btn">
