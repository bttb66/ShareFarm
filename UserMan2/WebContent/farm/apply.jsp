         ...
         <div class="contents_con">
            ...
            <form id="form" name="form" method="POST" action="/UserMan2/farm/apply?farmId=<%=String.valueOf(farm.getFarmId()) %>&farmName=<%=farm.getFarmName() %>">
               <div class="rental_sub01_write_con">
                  <div class="title_con">
                     <img src="<c:url value='/images/rental/rental_sub01_write_title.png'/>" alt="신청하기" />
                  </div>
                  ...
                  <div class="write_con">
                     <div class="list_div">
                        <div class="title_con">
                           <img src="<c:url value='/images/rental/rental_sub01_write_sub_title01.png'/>" alt="호스트 정보" />
                        </div>
                     ...
                     <div class="list_div">
                        <div class="title_con">
                           <img src="<c:url value='/images/rental/rental_sub01_write_sub_title02.png'/>" alt="게스트 정보" />
                        </div>
                   ...
                   <div class="btn_con">
                     <a href="javascript:history.go(-1);">
                        <img src="<c:url value='/images/rental/rental_sub01_write_btn01.png'/>" alt="전단계로 이동" />
                     </a>

                     <input id="applyBtn" type="image" src="<c:url value='images/rental/rental_sub01_write_btn02.png'/>" alt="등록하기"  onClick="applyFarm()"/>
                  </div>
               </div>
            </form>
            <!-- <div class="btn_con">
