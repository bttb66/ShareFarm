...
<tr>
   <td><a href="/UserMan2/farm/detail?farmId=${apply.farmId }">
   ${apply.name }</a></td>
   <td>${apply.startDate }</td>
   <td>${apply.endDate }</td>
   <td><a href="<c:url value='/apply/farmOk'>
   	<c:param name='applyId' value='${apply.applyId }'/>
   	<c:param name='kind' value='farm'/>
   </c:url>"><button id="ok">승인</button></a></td>
   <td><a href="<c:url value='/apply/farmCancel'>
   	<c:param name='applyId' value='${apply.applyId }'/>
   	<c:param name='kind' value='farm'/>
